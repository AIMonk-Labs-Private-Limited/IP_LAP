...
def predict(input_video_path,input_audio_path,temp_dir,mp_face_mesh,drawing_spec,fa,output_dir,all_landmarks_idx,pose_landmark_idx,content_landmark_idx,landmark_generator_model,renderer):
    ...
    boxes, lip_dists, face_crop_results, all_pose_landmarks, all_content_landmarks = detection(
        mp_face_mesh, all_landmarks_idx, pose_landmark_idx, content_landmark_idx, ori_background_frames
    )
    ...
    ref_imgs, ref_img_sketches, ref_imgs = draw_sketches(
        drawing_spec, lip_dist_idx, input_vid_len, face_crop_results, all_pose_landmarks, all_content_landmarks
    )
    ...
    render_loop(
        landmark_generator_model, renderer, drawing_spec, fa,temp_dir, input_mel_chunks_len, mel_chunks,
...
predict(input_video_path,input_audio_path,temp_dir,mp_face_mesh,drawing_spec,fa,output_dir,all_landmarks_idx,pose_landmark_idx,content_landmark_idx,landmark_generator_model,renderer)